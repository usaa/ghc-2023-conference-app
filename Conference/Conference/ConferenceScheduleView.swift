...
struct ConferenceScheduleView: View {
    ...
    init() {
        self.conferenceSchedule = ConferenceSchedule(userID: 98765,
                                                     sessions:[
            Session(id: 1, title: "Intro To Mobile Design Patterns", body: "9:00am - 10:00am", isRegistered: false),
            Session(id: 2, title: "Navigation Patterns", body: "10:15am - 11:00am", isRegistered: false),
...
struct ConferenceScheduleView_Previews: PreviewProvider {
